...
namespace eval ::optrace {
  variable script "/home/skltmw05/workspace/vivado/SKL_ZED/SKL_ZED_Jan_04_full.runs/impl_1/Zed_v1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/skltmw05/workspace/vivado/SKL_ZED/SKL_ZED_Jan_04_full.runs/synth_1/Zed_v1_wrapper.dcp
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top Zed_v1_wrapper -part xc7z020clg484-1 
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Zed_v1_wrapper_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file Zed_v1_wrapper_drc_opted.rpt -pb Zed_v1_wrapper_drc_opted.pb -rpx Zed_v1_wrapper_drc_opted.rpx"
...
OPTRACE "Power Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Zed_v1_wrapper_pwropt.dcp
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Zed_v1_wrapper_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file Zed_v1_wrapper_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file Zed_v1_wrapper_utilization_placed.rpt -pb Zed_v1_wrapper_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file Zed_v1_wrapper_control_sets_placed.rpt"
...
OPTRACE "Post-Place Power Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Zed_v1_wrapper_postplace_pwropt.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Zed_v1_wrapper_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Zed_v1_wrapper_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file Zed_v1_wrapper_drc_routed.rpt -pb Zed_v1_wrapper_drc_routed.pb -rpx Zed_v1_wrapper_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file Zed_v1_wrapper_methodology_drc_routed.rpt -pb Zed_v1_wrapper_methodology_drc_routed.pb -rpx Zed_v1_wrapper_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file Zed_v1_wrapper_power_routed.rpt -pb Zed_v1_wrapper_power_summary_routed.pb -rpx Zed_v1_wrapper_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file Zed_v1_wrapper_route_status.rpt -pb Zed_v1_wrapper_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file Zed_v1_wrapper_timing_summary_routed.rpt -pb Zed_v1_wrapper_timing_summary_routed.pb -rpx Zed_v1_wrapper_timing_summary_routed.rpx"
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file Zed_v1_wrapper_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file Zed_v1_wrapper_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file Zed_v1_wrapper_bus_skew_routed.rpt -pb Zed_v1_wrapper_bus_skew_routed.pb -rpx Zed_v1_wrapper_bus_skew_routed.rpx"
...
OPTRACE "route_design write_checkpoint" END { }
  write_checkpoint -force Zed_v1_wrapper_routed_error.dcp
...
OPTRACE "Post-Route Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Zed_v1_wrapper_postroute_physopt.dcp
OPTRACE "Post-Route Phys Opt Design: write_checkpoint" END { }
OPTRACE "phys_opt_design reports" START { REPORT }
  create_report "impl_1_post_route_phys_opt_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -warn_on_violation -file Zed_v1_wrapper_timing_summary_postroute_physopted.rpt -pb Zed_v1_wrapper_timing_summary_postroute_physopted.pb -rpx Zed_v1_wrapper_timing_summary_postroute_physopted.rpx"
  create_report "impl_1_post_route_phys_opt_report_bus_skew_0" "report_bus_skew -warn_on_violation -file Zed_v1_wrapper_bus_skew_postroute_physopted.rpt -pb Zed_v1_wrapper_bus_skew_postroute_physopted.pb -rpx Zed_v1_wrapper_bus_skew_postroute_physopted.rpx"
